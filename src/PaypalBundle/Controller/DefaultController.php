...
{
    public function getArtistInfoAction(Request $request)
    {
        ...
        if ($request->isXMLHttpRequest()) {
            ...
            $user = $em->createQuery(
                "SELECT u.userId, u.userProfilephoto, u.userName, u.userFirstgivenname, u.userSecondgivenname, 
                u.userFirstfamilyname, u.userSecondfamilyname, u.userEmail                     
            ...
            $userProfilephoto_Value = $user_e[0]['userProfilephoto'];
            $userName_Value = $user_e[0]['userName'];
            $userFirstgivenname_Value = $user_e[0]['userFirstgivenname'];
            $userSecondgivenname_Value = $user_e[0]['userSecondgivenname'];
            $userFirstfamilyname_Value = $user_e[0]['userFirstfamilyname'];
            $userSecondfamilyname_Value = $user_e[0]['userSecondfamilyname'];
            $userEmail_Value = $user_e[0]['userEmail'];
            ...
            $followers = $em->createQuery(
                ...
                WHERE u.userId = '$userId_Value'"
            );
            $followers_e = $followers->getResult();

            $amountFollowers = 0;
            while (isset($followers_e[$amountFollowers]['userId'])) {
                $amountFollowers++; // 
            }
            ...
            $influencers_e = $influencers->getResult();
            
            $amountInfluencers = 0;
            while (isset($influencers_e[$amountInfluencers]['userId'])) {
                $amountInfluencers++; // 
            }
